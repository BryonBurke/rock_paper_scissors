...
|---|---|---|
| rock beats scissors | user:rock computer:scissors | user wins |
| paper beats rock | user:rock computer:paper | user loses |
| scissors beats paper | user:scissors computer:paper | user wins |
| scissors ties scissors | user:scissors computer:scissors | tie |
